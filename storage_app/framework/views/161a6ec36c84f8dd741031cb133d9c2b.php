        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/4">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm sticky top-24">
                    ...
                    <div class="space-y-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedBrand && count($carTypes) > 0): ?>
                        <div>
            ...
            <div class="w-full md:w-3/4">
                <div class="mb-4 flex justify-between items-center">
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-400">Showing <?php echo e($cars->firstItem() ?? 0); ?> - <?php echo e($cars->lastItem() ?? 0); ?> of <?php echo e($cars->total()); ?> results</span>
                </div>
                                ...
                                <div class="aspect-[16/10] bg-gray-200 dark:bg-gray-700 relative overflow-hidden group">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($car->images->count() > 0): ?>
                                        <img src="<?php echo e(Storage::url($car->images->first()->image_path)); ?>" 
                                             alt="<?php echo e($car->brand->name ?? $car->make->name ?? ''); ?> <?php echo e($car->type->name ?? $car->model->name ?? ''); ?>" 
                                    ...
                                    <div class="absolute top-2 right-2 bg-primary-600 text-white text-xs font-bold px-2 py-1 rounded">
                                        <?php echo e($car->year_of_manufacture); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($car->brand && $car->brand->logo_path): ?>
                                        <div class="absolute bottom-2 left-2 bg-white/80 p-1 rounded-full">
                                            <img src="<?php echo e(Storage::url($car->brand->logo_path)); ?>" class="h-6 w-6 object-contain">
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div class="p-4 flex flex-col flex-grow">
                                    <div class="mb-2">
                                        <h3 class="text-lg font-bold text-gray-900 dark:text-white leading-tight">
                                            <?php echo e($car->brand->name ?? $car->make->name ?? 'Unknown'); ?> 
                                            <?php echo e($car->type->name ?? $car->model->name ?? 'Vehicle'); ?>

                                        </h3>
                                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($car->color); ?> • <?php echo e(number_format($car->mileage)); ?> km</p>
                                    </div>
                                    ...
                                    <div class="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                                        <span class="text-xl font-bold text-secondary-600 dark:text-secondary-400">
                                            €<?php echo e(number_format($car->selling_price)); ?>

                                        </span>
                                        <a href="<?php echo e(route('cars.show', $car->id)); ?>" class="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 transition">
                                            View Details
                                        </a>
                                    </div>
                                </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/car-listing.blade.php ENDPATH**/ ?>