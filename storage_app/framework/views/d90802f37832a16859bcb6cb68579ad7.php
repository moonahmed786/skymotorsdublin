...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label', 'field', 'sortField', 'sortDirection']));
...
foreach (array_filter((['label', 'field', 'sortField', 'sortDirection']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
</th><?php /**PATH /var/www/html/resources/views/components/table-sort-header.blade.php ENDPATH**/ ?>