    ...
    <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-8">
        ...
        <div>
            ...
            <ul role="list" class="space-y-1">
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>"
                        class="<?php echo e(request()->routeIs('dashboard') ? 'bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-md shadow-blue-500/20' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?> group flex gap-x-3 rounded-xl p-2.5 text-sm leading-6 font-medium transition-all duration-200">
                        <svg class="<?php echo e(request()->routeIs('dashboard') ? 'text-white' : 'text-slate-500 group-hover:text-white'); ?> h-5 w-5 shrink-0 transition-colors"
            ...
            <ul role="list" class="space-y-1">
                <li>
                    <a href="<?php echo e(route('admin.cars.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.cars.*') ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'); ?> group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all duration-200">
                        <svg class="<?php echo e(request()->routeIs('admin.cars.*') ? 'text-blue-500' : 'text-slate-500 group-hover:text-white'); ?> h-5 w-5 shrink-0 transition-colors"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <a href="<?php echo e(route('admin.brands.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.brands.*') ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'); ?> group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all duration-200">
                        <svg class="<?php echo e(request()->routeIs('admin.brands.*') ? 'text-blue-500' : 'text-slate-500 group-hover:text-white'); ?> h-5 w-5 shrink-0 transition-colors"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <a href="<?php echo e(route('admin.car-types.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.car-types.*') ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'); ?> group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all duration-200">
                        <svg class="<?php echo e(request()->routeIs('admin.car-types.*') ? 'text-blue-500' : 'text-slate-500 group-hover:text-white'); ?> h-5 w-5 shrink-0 transition-colors"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
                        </svg>
            ...
            <ul role="list" class="space-y-1">
                <li>
                    <a href="<?php echo e(route('admin.users.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.users.*') ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'); ?> group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all duration-200">
                        <svg class="<?php echo e(request()->routeIs('admin.users.*') ? 'text-blue-500' : 'text-slate-500 group-hover:text-white'); ?> h-5 w-5 shrink-0 transition-colors"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <a href="<?php echo e(route('admin.roles.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.roles.*') ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'); ?> group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all duration-200">
                        <svg class="<?php echo e(request()->routeIs('admin.roles.*') ? 'text-blue-500' : 'text-slate-500 group-hover:text-white'); ?> h-5 w-5 shrink-0 transition-colors"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
