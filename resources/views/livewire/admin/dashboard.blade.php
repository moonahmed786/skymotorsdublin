    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-slate-500">Welcome back, {{ Auth::user()->name }}. Here's what's happening
                    today.</p>
            </div>
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <dl class="mt-4">
                        ...
                        <dd class="mt-1 text-3xl font-bold tracking-tight text-white">{{ number_format($totalCars) }}
                        </dd>
                    </dl>
                </div>
            </div>
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <dl class="mt-4">
                        ...
                        <dd class="mt-1 text-3xl font-bold tracking-tight text-white">{{ number_format($totalBrands) }}
                        </dd>
                    </dl>
                </div>
            </div>
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <dl class="mt-4">
                        ...
                        <dd class="mt-1 text-3xl font-bold tracking-tight text-white">{{ number_format($totalUsers) }}
                        </dd>
                    </dl>
                </div>
            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            {{ substr($car->make->name ?? $car->brand->name ?? '?', 0, 1) }}
                                        </div>
                                        <div class="ml-4">
                                            <div
                                                class="text-sm font-semibold text-slate-900 group-hover:text-blue-600 transition-colors">
                                                {{ $car->registration_number }}</div>
                                            <div class="text-xs text-slate-500 font-mono">{{ $car->chassis_number }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-slate-900">{{ $car->brand->name ?? 'N/A' }}</div>
                                    <div class="text-xs text-slate-500">{{ $car->model->name ?? 'N/A' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-2.5 py-1 inline-flex text-xs font-semibold rounded-full border 
                                            ...
                                            {{ $car->status === 'sold' ? 'bg-slate-50 text-slate-600 border-slate-200' : '' }}
                                            {{ $car->status === 'reserved' ? 'bg-amber-50 text-amber-700 border-amber-200' : '' }}
                                            {{ $car->status === 'in_service' ? 'bg-blue-50 text-blue-700 border-blue-200' : '' }}">
